...
from lightrag_app.models import Workspace, Document, TextChunk, Entity, Relation
...
class WorkspaceModelTest(TestCase):
    ...
    def test_workspace_creation(self):
        ...
        self.assertEqual(self.workspace.description, 'Test workspace')
        ...
        self.assertIsNotNone(self.workspace.updated_at)
    ...
    def test_workspace_unique_name(self):
...
class DocumentModelTest(TestCase):
    ...
    def test_document_creation(self):
        ...
        self.assertEqual(self.document.workspace, self.workspace)
...
class TextChunkModelTest(TestCase):
    ...
    def test_chunk_creation(self):
        ...
        self.assertEqual(self.chunk.workspace, self.workspace)
...
class EntityModelTest(TestCase):
    ...
    def test_entity_creation(self):
        ...
        self.assertEqual(self.entity.workspace, self.workspace)
...
class RelationModelTest(TestCase):
    ...
    def test_relation_creation(self):
        ...
        self.assertEqual(self.relation.workspace, self.workspace)
