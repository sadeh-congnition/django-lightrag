...
class LightRAGCoreTest(TestCase):
    ...
    def setUp(self):
        ...
        with patch('lightrag_app.core.LadybugGraphStorage'), \
             patch('lightrag_app.core.ChromaVectorStorage'):
    ...
    def test_ingest_document_failure(self):
        ...
        with patch.object(self.core, '_chunk_text', side_effect=Exception("Test error")):
